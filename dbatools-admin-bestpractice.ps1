...
# standard
Restore-DbaDatabase  -SqlInstance localhost -Path C:\temp\SQL2016_Cube_Query_History_FULL_20170206_115448.bak
Restore-DbaDatabase  -SqlInstance localhost -Path C:\temp\SQL2016_Cube_Query_History_FULL_20170206_115448.bak -WithReplace

# ola!
Invoke-Item \\nas\sql\SQL2016\db1
Restore-DbaDatabase  -SqlInstance sql2016 -Path \\nas\sql\SQL2016\db1 -WithReplace -DestinationDataDirectory C:\temp
...
# history
Get-DbaBackupHistory  -SqlInstance sql2005 -Databases dumpsterfire4, db_2005_CL80 | Out-GridView
...
Test-DbaLastBackup  -SqlInstance sql2005 | Out-GridView
Test-DbaLastBackup  -SqlInstance sql2005 -Destination localhost\sql2016 -VerifyOnly | Out-GridView
...
Get-DbaDatabaseFreespace  -SqlInstance $instance -IncludeSystemDBs | Out-DbaDataTable | Write-DbaDataTable  -SqlInstance $instance -Table tempdb.dbo.DiskSpaceExample -AutoCreateTable
...
Test-DbaFullRecoveryModel  -SqlInstance sql2005 | Where { $_.ConfiguredRecoveryModel -ne $_.ActualRecoveryModel }
...
# sp_whoisactive
Show-SqlWhoisActive  -SqlInstance $instance # -ShowOwnSpid -ShowSystemSpids
